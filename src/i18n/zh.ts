export const zh = {
  ...
  workspace: {
    ...
    emptyTitleNoWs: "无工作区",
    emptyBodyHas:
      "一个 issue 就是一条工作主线，可以拆到多个仓库同时推进。新建后，Weft 会梳理改动范围、拆出执行任务，需要你拍板的事会主动送到你面前。",
  ...
  onboarding: {
    ...
    heroBody: "描述一个需求，Weft 会读取仓库地图、梳理改动范围、拆出任务，并把进展推进到 PR。",
    ...
    removeRepo: "移除",
    graphTitle: "依赖图自动成形",
    graphBody: "从包清单连边。这张图装不进任何单个仓——它是后面跨仓拆解的依据。",
    firstIssueTitle: "新建第一个 issue",
    firstIssueBody: "选择类型并填写 Task。Lead 会读取仓库地图，再梳理改动范围。",
    scopeTitle: "Lead 梳理跨仓改动范围",
    scopeBody: "一个 Task → 改哪些仓、做什么、什么顺序。Weft 会先给出可审阅的拆分，你只需校准写入范围。",
    ...
    body: "从一个工作区开始。选入本地仓库后，Weft 会建立仓库地图，再在每个 issue 里梳理范围、拆出任务、持续验证。",
    stepRepos: "选择仓库",
    stepReposBody: "引用现有 git 仓库，不拷贝代码。",
    stepMap: "生成地图",
    stepMapBody: "记录每个仓库的职责、技术栈和依赖关系。",
    stepIssue: "拆解工作",
    stepIssueBody: "Lead 根据 issue 判断哪些仓库要改、哪些只作参考。",
  ...
  lead: {
    ...
    compose: "给 lead 发消息…",
    attachFile: "@ 文件",
    autoDispatchHint: "Lead 自动拆解并推进 · Weft 不设审批关卡",
    ...
    noSubtasksYet: "Lead 梳理范围后，这里会出现子任务。",
    ...
    taskEmptyBody:
      "告诉 Lead 目标和约束；它会读取仓库地图、梳理范围，并拆出清晰的执行任务。",
    onboardingCueEyebrow: "从目标到可执行任务",
    onboardingCueBody:
      "只需描述一次目标。Lead 会梳理实施路径、拆出清晰任务，并把每一步进展持续展示在这里。",
    suggestionLabel: "可以试试",
    suggestionPlan: "先梳理实施路径",
    suggestionQueue: "拆成清晰任务推进",
    ...
    repoGuideStepMap: "Weft 会为仓库画像，并更新用于范围判断的仓库地图。",
