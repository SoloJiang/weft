export const zh = {
  ...
  attention: {
    leadStartFailed: "对话未能打开",
    leadResumeFailed: "对话未能恢复",
    leadTurnError: "对话因错误中止",
    leadFailed: "对话需要关注",
    dirStartFailed: "工人未能启动",
    dirResumeFailed: "任务对话未能恢复",
    dirTurnFailed: "上一轮失败",
    dirQuotaExceeded: "已达用量上限",
    dirUndelivered: "消息未能送达",
    dirAttention: "需要关注",
    inboxReview: "可以验收",
    issueNeedsYou: "待你处理",
  },
