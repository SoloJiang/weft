export const zh = {
  ...
  onboarding: {
    ...
    firstIssueBody: "选择类型并填写 Task。Lead 会读取仓库地图，再划定 scope。",
  ...
  lead: {
    ...
    repoGuideStepMap: "Weft 会为仓库画像，并更新用于 scope 判断的仓库地图。",
  ...
  repomap: {
    ...
    expandCurator: "打开依赖助手",
    collapseCurator: "收起依赖助手",
    deleteRepo: "从工作区移除",
