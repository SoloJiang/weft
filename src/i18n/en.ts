export const en = {
  ...
  scope: {
    ...
    dependsOn_one: 'Waits for "{{name}}"',
    dependsOn_other: "Waits for all: {{name}}",
    dependsOnHint_one: 'Blocked from merging until "{{name}}" lands',
    dependsOnHint_other: "Blocked from merging until all of these land: {{name}}",
    engine: "Engine",
  ...
  settings: {
    ...
    autoMergeConfirm:
      "Enable auto-merge? Weft will squash-merge every tracked PR/MR that already meets — or next reaches — this repo's truly-mergeable bar, on its own, without asking you each time, possibly several at once right away. It checks CI, GitHub's own review decision, unresolved review threads and conflicts — but not whether a particular review bot has signed off. This cannot be undone once it happens.",
  ...
  readiness: {
    ...
    reason: {
      ...
      upstream_unmet: "Upstream delivery is not complete",
      evidence_missing: "Readiness evidence is still loading",
      remote_unknown: "Remote delivery evidence is unavailable",
      execution_drifted: "Worktree branch drifted from the lane",
      policy_gate_pending: "Waiting for the policy gate",
      open_need: "A human answer is needed",
      checks_failing: "Verification checks are failing",
      checks_unknown: "Verification checks have not run",
      worker_failed: "The worker ended with an error",
      in_progress: "Delivery is still in progress",
      pr_ci_pending: "PR CI is still pending",
      pr_ci_failing: "PR CI is failing",
      pr_review_changes_requested: "PR review requested changes",
      pr_threads_unresolved: "PR review threads are unresolved",
      pr_conflict: "PR has merge conflicts",
  ...
  changeSet: {
    tab: "Change set",
    title: "Change set",
    loading: "Loading the change set…",
    loadFailed: "Couldn't load the change set.",
    empty: "No lanes yet — this issue writes nothing so far.",
    laneCount_one: "{{count}} active lane",
    laneCount_other: "{{count}} active lanes",
    wave: "Step {{index}}",
    waveWaits: "waits on the step above",
    whyRepo: "Why this repo",
    openLane: "Open this lane's session",
    branchUnset: "no branch yet",
    baseDefault: "repo default branch",
    dependsOn_one: "waits on {{count}} lane",
    dependsOn_other: "waits on {{count}} lanes",
    evidenceCounts: "evidence {{fresh}} fresh · {{stale}} stale · {{unknown}} unknown",
    evidenceNone: "no evidence recorded",
    checkout: {
      notProbed: "Checkout not sampled in this read.",
      noneRegistered: "No worktree registered yet.",
      unsampled: "checkout could not be read",
    ...
    pr: {
      ...
      reviewAwaiting: "awaiting approval",
      reviewApproved: "approved",
      threadsUnchecked: "threads not checked",
      threadsUnknown: "threads unknown",
      threadsResolved: "threads resolved",
      threadsUnresolved: "threads unresolved",
      conflictUnknown: "mergeability unknown",
      conflictClean: "no conflict",
    ...
    checks: {
      not_applicable: "checks not due yet",
      not_produced: "no check result",
      passed: "checks passed",
      failing: "checks failing",
    },
    upstream: {
      satisfied: "upstream ready",
      unmet: "upstream not delivered",
