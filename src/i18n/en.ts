export const en = {
  ...
  dialog: {
    ...
    clonePasteHint: "Paste one or more git URLs — newline, space, or comma separated.",
    ...
    addRepoTooltip: "Tip: paste multiple git URLs to import them at once",
    adding: "Adding…",
    addReposCta: "Add {{count}} repos",
    localPickHint: "Type a path, or pick one or more folders to add at once.",
