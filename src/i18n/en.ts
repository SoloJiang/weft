export const en = {
  ...
  workspace: {
    ...
    emptyBodyHas:
      "An issue is one work line you can move across repos. Start one and Weft shapes the scope, splits clear tasks, and surfaces what needs you.",
  ...
  onboarding: {
    ...
    heroBody: "Describe the work; Weft reads the repo map, shapes the scope, splits clear tasks, and moves it toward a PR.",
    ...
    firstIssueBody: "Choose a type and write the task. The lead reads the repo map, then scopes the work.",
    ...
    body: "Start with one workspace. Add local repos, and Weft builds the repo map that helps each issue shape scope, split tasks, and verify progress.",
    ...
    stepIssue: "Split the work",
    stepIssueBody: "The lead decides which repos change and which ones only provide context.",
  ...
  lead: {
    ...
    attachFile: "@ file",
    autoDispatchHint: "Lead decomposes and moves work forward · no Weft approval gate",
    ...
    taskEmptyBody:
      "Tell the lead the goal and constraints. It reads the repo map, shapes the scope, and splits the work into clear tasks.",
    onboardingCueEyebrow: "From goal to tasks",
    onboardingCueBody:
      "Describe the outcome once. The lead shapes the path, splits clear tasks, and keeps progress visible here.",
    suggestionLabel: "Try",
    suggestionPlan: "Shape the implementation path",
    suggestionQueue: "Break it into clear tasks",
