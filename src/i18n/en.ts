export const en = {
  ...
  attention: {
    leadStartFailed: "Chat could not be opened",
    leadResumeFailed: "Chat could not be recovered",
    leadTurnError: "Chat stopped with an error",
    leadFailed: "Chat needs attention",
    dirStartFailed: "The worker could not start",
    dirResumeFailed: "The task chat could not be recovered",
    dirTurnFailed: "The last turn failed",
    dirQuotaExceeded: "Usage limit reached",
    dirUndelivered: "A message could not be delivered",
    dirAttention: "Needs attention",
    inboxReview: "Ready for you to accept",
    issueNeedsYou: "Needs you",
  },
  palette: {
    search: "Search",
  ...
  thread: {
    ...
    acceptingResult: "Accepting…",
    acceptResultFailed: "Couldn't accept this result — try again.",
